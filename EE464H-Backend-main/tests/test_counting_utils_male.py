...
class test_unit_counting(unittest.TestCase):
    ...
    def test_get_count_total(self):
        ...
        #Assert
        assert actual_count_enrollment == 191
        assert actual_count_graduation == 124
    ...
    def test_get_count_total_regional(self):
        ...
        assert actual_count_regional_enrollment == 170412
        assert actual_count_regional_graduation == 36590
    ...
    def test_get_count_total_national_enrollment(self):
        ...
        assert actual_count_national == 998357
    ...
    def test_get_count_total_national_graduation(self):
        ...
        assert actual_count_national == 299822
